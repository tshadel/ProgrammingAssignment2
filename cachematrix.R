# this function works like a class, it gets a list
...
makeCacheMatrix <- function(x=matrix()) {
  ...
  # as setter function, use this to set a matrix to object created by makeCacheMatrix function
  # e.g makeCacheMatrix(testmatrix) # here we work on testmatrix
  # makeChacheMatrix(testmatrix1) # here we work on testmatrix1
  set <- function(y) {
    x <<- y
